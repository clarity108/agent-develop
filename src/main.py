...
def build_llm_agent():
    ...
    tools = {
        ...
        "code_review": create_code_review_tool(client),
        "diff_review": create_diff_review_tool(client),
        "git_diff_review": create_git_diff_review_tool(client),
...
def main():
    ...
    if args.plan:
        ...
        tools = {
            ...
            "batch_replace": batch_replace, "batch_rename": batch_rename,
            "batch_move": batch_move, "batch_delete": batch_delete,
            "find_in_files": find_in_files, "batch_format": batch_format,
